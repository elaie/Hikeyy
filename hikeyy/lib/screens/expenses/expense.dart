...
class _ExpensesState extends State<Expenses> {
  ...
  Future<String> getUserName(String id) async {
    DocumentSnapshot data = await FirebaseFirestore.instance.collection('Users').doc(id).get();
            ...
            Padding(
              ...
              child: Container(
                child: StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance.collection('Groups').doc(widget.id).collection('Expenses')
                        .snapshots(),
                            ...
                            FirebaseFirestore.instance.collection('Groups').doc(
                                widget.id).collection('Expenses').add(
                                {
                                  ...
                                  'Amount': _amountController.text.trim()
                                      .toString(),
                                  'Time': DateTime.now(),
                                  'PaidBy': FirebaseAuth.instance.currentUser!
                                      .uid
                                }).then((value) {
